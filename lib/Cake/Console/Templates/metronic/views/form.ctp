    ...
    <div class="col-md-12">
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-reorder"></i><?php printf("<?php echo __('%s %s'); ?>", Inflector::humanize($action), $singularHumanName); ?>
                </div>
                <div class="tools">
                ...
                <div class="form-body">
            		...
            		foreach ($fields as $field) {
            			if (strpos($action, 'add') !== false && $field === $primaryKey) {
                            ...
                            echo "\t<label class='col-md-3 control-label'>{$field}</label>\n";
            		...
            		if (!empty($associations['hasAndBelongsToMany'])) {
            			foreach ($associations['hasAndBelongsToMany'] as $assocName => $assocData) {
                            echo "<div class='form-group'>\n";
                            echo "\t<label class='col-md-3 control-label'>{$assocName}</label>\n";
                            echo "\t<div class='col-md-4'>\n";
