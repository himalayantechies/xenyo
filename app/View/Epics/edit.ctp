    ...
    <div class="col-md-12">
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption"><i class="fa fa-reorder"></i><?php echo __('Edit Epic'); ?></div>
            </div>
            <div class="portlet-body form">
                ...
                <div class="form-body">
					...
					<div class='form-group'>
						...
						<div class='col-md-4'><?php echo $this->Form->input('project_id'); ?></div>
					</div>
					<div class='form-group'>
						<label class='col-md-3 control-label'>Client</label>
						<div class='col-md-4'><?php echo $this->Form->input('client_id'); ?></div>
					</div>
					<?php /*
					<div class='form-group'>
						...
						<div class='col-md-4'>
							<?php
							$options = array('Epic' => 'Epic', 'Task' => 'Task', 'Story' => 'Story', 'Bug' => 'Bug',
											 'Technical task' => 'Technical task', 'Sub-task' => 'Sub-task', 'Meeting' => 'Meeting');
							echo $this->Form->input('issuetype', array('options' => $options)); 
							?>
						</div>
					</div>
					*/ ?>
					...
					<div class='form-group'>
						<label class='col-md-3 control-label'>Epic Name</label>
						<div class='col-md-4'><?php echo $this->Form->input('epic_name'); ?></div>
					</div>
					<div class='form-group'>
					...
					<div class='form-group'>
						...
						<div class='col-md-4'><?php echo $this->Form->input('assignee'); ?></div>
					</div>
					<div class='form-group'>
					...
					<div class='form-group'>
						...
						<div class='col-md-4'><?php echo $this->Form->input('business_value'); ?></div>
					</div>
					<div class='form-group'>
